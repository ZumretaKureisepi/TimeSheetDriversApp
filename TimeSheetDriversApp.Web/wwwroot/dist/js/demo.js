...
(function ($) {
  ...
  $('.product-image-thumb').on('click', function () {
    ...
    $('input[name="selectedRequests"]').change(function () {
        if ($(this).prop('checked')) {
            $('button[name="Action"]').removeAttr('disabled');
        }
        else {
            var checked_count = $('input[name="selectedRequests"]:checked').length;
            if (checked_count == 0)
    ...
    $('#Users_dropdown').multiselect();
    $('#Months_dropdown').multiselect();
